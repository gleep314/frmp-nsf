...
Kaemika is...\todo{PM, can you shut down Kaemika without offending Luca?}
...
Since the semantics and use of deterministic CRNs and stochastic CRNs are so wildly\todo{reword} different, we separate our proposed work into two main sections.
...
\todo{Do we actually need this summary paragraph or is it a little overkill?}

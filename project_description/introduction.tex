...
%%%%%%%%%%%%%%%%%%%%%%%%
\todo{Add references to relevant 2020 papers}
...
\todo{Add a sentence here that makes the broader impact of CRN research clear}
...
\todo{Add Cardelli's new CRN programming language here}
...
\todo{Add discussion of Cardelli's paper here}
...
\todo{Update summary of our proposed work to match new thrust of research}
...
\todo{Add a paragraph outlining the rest of the proposal here}
...
%     * Arrow typeclass
%     * Connections to temporal logics such as LTL, STL, etc.
%

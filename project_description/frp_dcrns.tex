...
\end{displayquote}
In \reactamole, we realize this with a type, \hask{DCRN a b}, the type of deterministic CRNs that take values of type \hask{a} as input and produce values of type \hask{b}.

...
This means that the inputs to a CRN effectively are read-only values which allows \reactamole{}'s combinators to manipulate CRNs in a functional manner, avoiding thorny issues such as race conditions between reactants.

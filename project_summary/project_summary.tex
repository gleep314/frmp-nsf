...
\begin{document}
    ...
    To this end, we propose the investigation of foundations-based language support for molecular programming based on \emph{functional reactive programming} (\emph{FRP}), noting that a chemical reaction network is inherently \emph{reactive} in nature.
    % FRP allows us to specify networks of intercommunicating objects, here, molecules, in a manner that allows us to retain the benefits of modular reasoning. 
